#!/bin/bash
# quadlets-setup.sh - Configuración de directorios y servicios systemd Quadlets para Podman en CachyOS + GNOME
#
# Uso:
...
show_help() {
    cat <<EOF
⚙️ Gestor de Quadlets para Podman - CachyOS (GNOME)
