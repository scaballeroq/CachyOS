#!/bin/bash
# podman-install.sh - Optimización y configuración de Podman Rootless + Socket + Quadlets para CachyOS + GNOME
#
# Uso:
...
show_help() {
    cat <<EOF
🐳 Optimizador y Configurador de Podman Rootless - CachyOS (GNOME)
...
show_status() {
    echo "================================================================="
    echo "🔍 ESTADO DE PODMAN ROOTLESS - CACHYOS (GNOME)"
    echo "================================================================="
...
case "${1:-}" in
    ...
    "")
        echo "================================================================="
        echo "🐳 OPTIMIZADOR DE PODMAN ROOTLESS - CACHYOS (GNOME)"
        echo "================================================================="
        require_non_root
        install_packages
        configure_storage
