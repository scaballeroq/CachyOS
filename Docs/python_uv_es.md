...
# Guía de Desarrollo en Python con uv en CachyOS

Esta guía describe el flujo de trabajo moderno y seguro para el desarrollo en **Python** en CachyOS, utilizando **`uv`** y entornos virtuales aislados sin interferir con las aplicaciones ni las herramientas del sistema operativo (**GNOME Tweaks / Retoques**, Pacman, extensiones, etc.).

---

## 🧠 Filosofía y Arquitectura del Entorno

En distribuciones rolling-release como **Arch Linux** y **CachyOS**, muchas herramientas críticas del sistema operativo (como *Retoques de GNOME*, *Lutris*, scripts de empaquetado y utilidades del sistema) dependen de **`/usr/bin/python3`** y sus librerías empaquetadas por Pacman (`python-gobject`, `libadwaita`, etc.).
...
* **Fuera del proyecto**: La terminal y el escritorio volverán inmediatamente al Python nativo de CachyOS.
