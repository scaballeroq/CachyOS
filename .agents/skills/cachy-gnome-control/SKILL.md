---
name: cachy-gnome-control
description: >-
  Use this skill when managing GNOME Shell, Mutter window manager, GNOME extensions, display/monitor settings (LG 32", Sony TV 32", Laptop), gsettings/dconf configurations, and Wayland desktop integration on CachyOS Linux.
---

# GNOME Shell & Mutter Control Skill (CachyOS Linux)

Esta skill proporciona los comandos y directrices para inspeccionar, configurar y gestionar el entorno de escritorio **GNOME Shell** y el compositor/gestor de ventanas **Mutter** sobre **Wayland** en CachyOS.
...
El entorno utiliza extensiones gestionadas tanto desde repositorios oficiales de CachyOS/Arch como desde EGO (extensions.gnome.org).
