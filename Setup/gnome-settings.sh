#!/bin/bash
# ==============================================================================
# gnome-settings.sh - Configuración y Personalización Avanzada de GNOME para CachyOS
# Optimizado para desarrollo de software, modo oscuro y estación de trabajo
# NOTA: Cero extensiones de GNOME añadidas (fase 1)
# ==============================================================================

set -euo pipefail

echo "================================================================="
echo "🎨 CONFIGURANDO ENTORNO GNOME EN CACHYOS (MODO OSCURO)"
echo "================================================================="
...
# 1. Herramientas esenciales de personalización (sin extensiones)
echo "📦 [1/6] Verificando herramientas de personalización..."
$SUDO pacman -S --needed --noconfirm gnome-tweaks adw-gtk-theme 2>/dev/null || true

# 2. Apariencia y Tema Oscuro Global
echo "🌙 [2/6] Aplicando tema oscuro persistente y fuentes de desarrollo..."
...
echo "================================================================="
echo "✅ Configuración de GNOME completada con éxito."
...
echo "   - Cero extensiones añadidas (lista para la fase 2)."
echo "================================================================="
