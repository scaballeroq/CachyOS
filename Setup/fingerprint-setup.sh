#!/bin/bash
# fingerprint-setup.sh - Configuración de autenticación por huella dactilar (fprintd) en CachyOS (GNOME, Sudo & PolKit)

set -euo pipefail

echo "🚀 Configurando desbloqueo y autenticación admin por huella dactilar en CachyOS..."
